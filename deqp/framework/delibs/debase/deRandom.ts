 ...
 */
var deRandom_init = function(rnd, seed: number): void
{
 ...
 */
var deRandom_getInt = function(rnd, opts?): number
{
 ...
 */
var deRandom_getFloat = function(rnd, opts?): number
{
    if (opts != undefined && opts[0] != undefined && opts[1] != undefined) {
        if (opts[0] <= opts[1]) {
 ...
 */
var deRandom_getBool = function(rnd): boolean
{
    var val;
 ...
 */
export var getBaseSeed = function(): number
{
    return 42;
};
 ...
 */
export var Random = function(seed: number) {
    /**
 ...
 * @return {boolean} Random boolean
 */
Random.prototype.getBool = function(): boolean  { return deRandom_getBool(this.m_rnd) == true; };
/**
 * Function to get random float
 * @param {deRandom} rnd Initialised array of random numbers
 * @param {array} opts Min and max for range
 * @return {float} Random float
 */
Random.prototype.getFloat = function(min, max): number { return deRandom_getFloat(this.m_rnd, [min, max]) };
/**
 * Function to get random int
 * @param {deRandom} rnd Initialised array of random numbers
 * @param {array} opts Min and max for range
 * @return {int} Random int
 */
Random.prototype.getInt = function(min, max): number {return deRandom_getInt(this.m_rnd, [min, max])};
/**
 * TODO Function to choose random items from a list
 * @param {Array.<Object>} elements Array segment already defined
 * @param {Array.<Object>} resultOut Array where to store the elements in. If undefined, default to array of (num) elements.
 ...
 * @return {number} constant
 */
Random.prototype.getBaseSeed = function(): number {
    return getBaseSeed();
};
